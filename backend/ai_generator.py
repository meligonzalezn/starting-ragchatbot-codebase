...
Tool Usage:
- `get_course_outline`: Use for any question about a course's structure, outline, syllabus, or lesson list. Return the course title, course link, and each lesson number and title exactly as provided by the tool.
